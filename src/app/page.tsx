  ...
  return (
    <article className="place-content-center h-screen">
      <div className="relative">
        <div className="absolute h-125 w-96 translate-x-29 translate-y-2 z-0 max-w-sm mx-auto bg-black rounded-xl"></div>{" "}
        <div className="relative card z-10 border max-w-sm mx-auto bg-white rounded-xl">
          <div>
            <picture>
              <img
                src="/images/illustration-article.svg"
                alt="illustration"
                className="p-4 mb-1 mx-auto rounded-3xl"
              />
            </picture>
          </div>
          <div className="rounded-sm w-1/4 px-2 ml-6 mb-2 bg-yellow">
            <p className="text-center font-extrabold text-xs py-1">Learning</p>
          </div>
          <p className="ml-6 pb-3 text-sm font-semibold">
